...
public class Journey_Details extends JFrame{  //Forth
	...
	String[] items1 =  {"Karachi", "Islamabad", "Peshawar", "Lahore ","Quetta","Faisalabad" ,"Multan " ,"Gwadar" ,"Faisalabad" ,};
	JComboBox comboBox = new JComboBox(items1);
	comboBox.setBounds(150, 100, 150, 27);
	add(comboBox);
		
		
	String[] items2 =   {"Islamabad", "Karachi", "Peshawar", "Lahore ","Quetta","Faisalabad" ,"Multan " ,"Gwadar" ,"Faisalabad" ,};
