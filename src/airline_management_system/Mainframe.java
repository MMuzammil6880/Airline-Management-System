...
public class Mainframe extends JFrame{
    ...
    private void initialize() {
      ...
      NewLabel.setIcon(new ImageIcon(ClassLoader.getSystemResource("airline/management/system/icon/PIA.jpg")));
	NewLabel.setBounds(0, 0, 1950,1090); 
	add(NewLabel); 

        JLabel AirlineManagementSystem = new JLabel("PAKISTAN INTERNATIONAL AIRLINE (PIA) WELCOMES YOU");
	AirlineManagementSystem.setForeground(Color.GREEN);
        AirlineManagementSystem.setFont(new Font("Tahoma", Font.PLAIN, 36));
	AirlineManagementSystem.setBounds(30, 60, 1000, 55);
